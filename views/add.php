...
<body class="body-home">
    <header class="header-home header-add">
            <div class="container">
                <div class="logo">
        ...
        <main>
            <section class="main-home container-add">
                ...
                <form method="POST" class="form-add">
                    ...
                    <input type="text" required name="cod" id="cod-bar">

                    <label for="desc-prod">Descrição</label>
                    <input type="text" required name="name" id="desc-prod">   

                    <label for="preco">Preço do Produto</label>
                    <input type="text" required name="price" id="preco">   

                    <label for="qtt">Quantidade</label>
                    <input type="text" required name="quantity" id="qtt"> 

                    <label for="min-qtt">Quantidade Mínima</label>
                    <input type="text" required name="min_quantity" id="min-qtt">
